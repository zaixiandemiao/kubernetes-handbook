...
---
>         image: registry.cn-hangzhou.aliyuncs.com/kube_containers/k8s-dns-kube-dns-amd64:1.14.1
88c88
...
---
>         image: registry.cn-hangzhou.aliyuncs.com/google-containers/k8s-dns-dnsmasq-nanny-amd64:1.14.1
129c129
...
---
>         image: registry.cn-hangzhou.aliyuncs.com/google_containers_mirror/k8s-dns-sidecar-amd64:1.14.1
161,162c161,162
...
## 遇到的错误
### dns调试
`kubectl get pods --namespace=kube-system`查看dns的pods是否正常  
`kubectl describe pods --namespace=kube-system`查看详细情况  
`kubectl logs pod_name -n kube-system` 查看kube-dns的日志


### dns出错,DNS Server not ready
原因: Pod内部网络为10开头
clusterIP:只能配置为10开头的内网地址